...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'hundzz', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚 ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-g1lz25drs-hundzz.vercel.app/', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/hundzz', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  CODE_COLLAPSE: process.env.NEXT_PUBLIC_CODE_COLLAPSE || flase, // 是否折叠代码框
  // END********代码相关********
